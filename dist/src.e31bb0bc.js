...
var swiper = exports.swiper = new Swiper(".swiper", {
...
var getWildberriesData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return fetch("https://fakestoreapi.com/products").then(function (response) {
            return response.json();
          });
        case 2:
          products = _context.sent;
          _context.next = 5;
          return fetch("https://fakestoreapi.com/users").then(function (response) {
            return response.json();
          });
        case 5:
          users = _context.sent;
  ...
  return function getWildberriesData() {
...
var runWildberriesApplication = /*#__PURE__*/function () {
      ...
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          createCardProduct = function _createCardProduct(imageCard, priceCard, titleCard, idCard) {
            ...
            var discountPriceItem = document.createElement("span");
            discountPriceItem.textContent = "New price ".concat((priceCard * 0.9).toFixed(2), " $");
            var priceItem = document.createElement("span");
            priceItem.classList.add("span__line-through");
            priceItem.textContent = "Old Price ".concat(priceCard, " $");
  ...
  return function runWildberriesApplication() {
    return _ref2.apply(this, arguments);
  };
}();
runWildberriesApplication();
},{"./swiper.js":"swiper.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
